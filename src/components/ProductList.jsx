...
export default function ProductList({ products, search }) {
  ...
  return (
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 sm:grid-cols-2 gap-4 md:px-4 md:py-12 xs:py-18 py-28">
      {filtered.map(product => (
        <Link key={product.id} to={`/product/${product.id}`}>
          <div
            key={product.id}
            className="w-full h-[750px] max-h-full p-2 max-w-sm mx-auto bg-gray-200 dark:bg-slate-600 text-slate-800 dark:text-white rounded-lg overflow-hidden shadow-lg transition-transform duration-300 ease-in-out transform hover:scale-101 hover:shadow-[0_15px_35px_rgba(255,255,255,0.3)] hover:drop-shadow-2xl hover:text-blue-700 dark:hover:bg-gray-500 hover:bg-gray-300 cursor-pointer"
          >
